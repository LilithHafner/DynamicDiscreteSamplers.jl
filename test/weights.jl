...
try
    let
        ...
        for rep in 1:1000
            ...
            opcount = 0
            DynamicDiscreteSamplers.COMPACT_TRACKER[] = false
            function track_and_test_compaction_frequency()
                opcount += 1
                if DynamicDiscreteSamplers.COMPACT_TRACKER[]
            ...
            for _ in 1:rand((10,100,3000))
                ...
                if x < .2 && !all(iszero, v)
                    ...
                    v[i] = 0
                    w[i] = 0
                    track_and_test_compaction_frequency()
